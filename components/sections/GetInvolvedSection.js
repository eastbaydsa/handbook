    ...
    return (
      <div>
        ...
        <P>
          ...
          into ongoing projects, (And if they don’t, feel free to email
        ...
        <P>
          ...
          courageous asks. These are skills you can apply inside the
          organization as you get your feet under you, but also outside of it:
        ...
        <SideBar title="Showing up builds trust" style="red">
          ...
          are tossed around without serious consideration of what it would take
          to make them happen. (And let’s not even TALK about online dating.)
          This is, undoubtedly, a consequence of living in a society where we’re
          taught to be consumers instead of a community, and where the
          prevailing ethos is “you don’t owe anyone anything.” We’ve all been
          guilty of this, at one point or another, but if we are going to
        ...
        <SideBar>
          ...
          minute, but that doesn’t foster a strong organization. Commit to
          something, and hold to it. We’re not asking you to martyr yourself,
          because that’s how burnout happens. Don’t take on more than you can
          sustain. We also recognize that not everyone has a few extra hours per
          week, because capitalism is awful. Just do what you can. You’re not
        ...
        <P>
          ...
          caucus) doing the organizing closest to your idea, get involved with
          their ongoing work, and once you have the lay of the land, ask some of
          the organizers to talk it over with you. The more you can take on the
        ...
        <SideBar title="Forming a caucus" style="red">
          ...
          interested in the same issues or shared experiences, or if you want to
          push the leadership to consider alternatives to the current path, a
          caucus might be what you’re looking for. Local caucuses have formed
          around socialist feminism, environmental justice, social housing, and
          the abolition of prisons and policing. (The website should always have
          an up-to-date list of formally recognized caucuses.) We also have
          caucuses with more subtle missions, like the Craft Caucus. Any member
          can form a caucus, for any reason. If you want your caucus to be
          officially recognized (which means you get listed on the website)
          you’ll need to get together five members and a statement that includes
        ...
        <P>
          ...
          mention you’re a member and speak your mind. There’s no muzzle here.
          Just make it clear you’re not speaking on behalf of the organization
          until you’re sure it’s a position approved by a democratic process.
          The Local Council approves official chapter representatives for the
          purposes of interacting with other organizations or within a coalition
        ...
        <P>
          ...
          for the membership or Local Council to vote on. If there’s a specific
          organizational need that falls outside the EOC/IOC frameworks (in the
          same way that Finance or the Secretary are necessarily council-level
