      ...
      <Section>
        ...
        <Container>
          ...
          <P>
            ...
            country. We need you (and two or more of your friends) to pitch in,
            show up, and drag a new world into being. There’s no time to lose,
          ...
          <P>
            ...
            and state legislators across the country. In 1982, a merger of
            Michael Harrington’s Democratic Socialist Organizing Committee with
            the New American Movement led to the creation of DSA, bringing
            together feminist, anti-Stalinist, and anti-imperialist currents
            from across the American Left. DSA is a “big tent”:{" "}
            <Strong>
          ...
          <P>
            ...
            members. The chapter as we know it (its structure, processes, and
            culture, right down to this handbook) were built by an all-volunteer
            force over the course of 2017. We’re figuring it out as we go, and
            as we all seek to understand and act in a new political context.
          </P>
          <P>
